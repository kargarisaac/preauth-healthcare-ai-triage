...
class BamlAsyncClient:
    ...
    async def FinalizePreAuthDecision(self, clinical_analysis: types.AgentAnalysis,medication_analysis: types.AgentAnalysis,risk_assessment: types.AgentAnalysis,decision_making: types.AgentAnalysis,compliance_audit: types.AgentAnalysis,patient_demographics: str,requested_services: str,clinical_context: str,
        baml_options: BamlCallOptions = {},
    ) -> types.FinalPreAuthDecision:
        result = await self.__options.merge_options(baml_options).call_function_async(function_name="FinalizePreAuthDecision", args={
...
class BamlStreamClient:
    ...
    def FinalizePreAuthDecision(self, clinical_analysis: types.AgentAnalysis,medication_analysis: types.AgentAnalysis,risk_assessment: types.AgentAnalysis,decision_making: types.AgentAnalysis,compliance_audit: types.AgentAnalysis,patient_demographics: str,requested_services: str,clinical_context: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.FinalPreAuthDecision, types.FinalPreAuthDecision]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="FinalizePreAuthDecision", args={
            "clinical_analysis": clinical_analysis,"medication_analysis": medication_analysis,"risk_assessment": risk_assessment,"decision_making": decision_making,"compliance_audit": compliance_audit,"patient_demographics": patient_demographics,"requested_services": requested_services,"clinical_context": clinical_context,
        })
        return baml_py.BamlStream[stream_types.FinalPreAuthDecision, types.FinalPreAuthDecision](
          result,
...
class BamlHttpRequestClient:
    ...
    async def FinalizePreAuthDecision(self, clinical_analysis: types.AgentAnalysis,medication_analysis: types.AgentAnalysis,risk_assessment: types.AgentAnalysis,decision_making: types.AgentAnalysis,compliance_audit: types.AgentAnalysis,patient_demographics: str,requested_services: str,clinical_context: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="FinalizePreAuthDecision", args={
            "clinical_analysis": clinical_analysis,"medication_analysis": medication_analysis,"risk_assessment": risk_assessment,"decision_making": decision_making,"compliance_audit": compliance_audit,"patient_demographics": patient_demographics,"requested_services": requested_services,"clinical_context": clinical_context,
        }, mode="request")
        return result
