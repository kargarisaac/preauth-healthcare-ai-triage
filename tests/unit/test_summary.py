...
pytest.skip(
    "legacy summary module removed; covered by orchestrator + LLM modules",
...
class TestClinicalSummary:
    ...
    def test_clinical_summary_creation(self):
        ...
        summary = ClinicalSummary(
            ...
            age=45,
            gender="M",
            active_conditions=[{"code": "E11.9", "description": "Type 2 diabetes"}],
            ...
            prior_treatments=[],
            treatment_responses=[],
            recent_labs=[{"test": "HbA1c", "value": 8.5, "date": "2025-07-01"}],
            recent_imaging=[],
            recent_procedures=[],
...
class TestEdgeCases:
    ...
    def test_egfr_calculation_edge_cases(self, mock_calculate_egfr):
        ...
        lab_results = [{"test_name": "Creatinine", "value": 1.2, "date": "2025-07-01"}]
...
class TestPerformance:
    ...
    def test_large_dataset_aggregation_performance(
        self, mock_get_data, performance_monitor
    ):
        ...
        mock_get_data.return_value = {
            "patient_info": {"patient_id": "P123", "age": 45, "gender": "M"},
            "conditions": [
                {"code": f"E11.{i}", "description": f"Condition {i}"} for i in range(50)
            ],
            "medications": [
                {"name": f"Medication_{i}", "dose": "500mg"} for i in range(20)
            ],
            "lab_results": [
