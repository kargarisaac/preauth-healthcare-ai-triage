"""
Medication Specialist Agent Configuration and Class
Dynamically loaded by DSPyAgent base class
"""
import dspy
from datetime import datetime
from preauth_system.signatures import AgentResult
from preauth_system.signatures import MedicationAnalysis
...
class MedicationSpecialist:
    """Medication Specialist Agent with centralized LM configuration and scoped DSPy usage."""

    def __init__(self):
        self.metadata = METADATA
        self.lm = get_openrouter_lm(agent_name=self.metadata["name"])
        self.react = dspy.ReAct(
            signature=MedicationAnalysis,
            tools=DEFAULT_TOOLS,
    ...
    async def analyze(self, context, previous_results):
        ...
        try:
            ...
            return AgentResult(
                ...
                response=result.medication_analysis,
                usage={
