"""
Risk Assessor Agent Configuration and Class
Dynamically loaded by DSPyAgent base class
"""
import dspy
from datetime import datetime
from preauth_system.signatures import RiskAssessment, AgentResult
...
class RiskAssessor:
    """Risk Assessor Agent with centralized LM configuration and scoped DSPy usage."""
    ...
    async def analyze(self, context, previous_results):
        ...
        try:
            ...
            return AgentResult(
                ...
                response=result.risk_assessment,
                usage={
