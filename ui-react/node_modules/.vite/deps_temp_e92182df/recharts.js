...
var ConcentricGridPath = (props) => {
  ...
  return React23.createElement("g", {
    ...
    var key = i;
    if (gridType === "circle")
      return React23.createElement(ConcentricCircle, _extends18({
        key
      }, props, {
        radius: entry,
        index: i
...
var YAxisImpl = (props) => {
  ...
  (0, import_react54.useLayoutEffect)(() => {
    ...
    if (width !== "auto" || !axisSize || isLabelContentAFunction(label) || (0, import_react54.isValidElement)(label))
      return;
