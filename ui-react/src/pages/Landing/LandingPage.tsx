...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg-primary transition-colors duration-200">
      {/* Navigation */}
      <nav className="bg-white dark:bg-dark-bg-secondary shadow-soft border-b border-gray-200 dark:border-dark-border-primary sticky top-0 z-50 backdrop-blur-sm bg-white/95 dark:bg-dark-bg-secondary/95 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <img src={logoImage} alt="Healthcare AI Platform" className="h-8 w-8" />
              <div className="ml-2">
                <span className="text-xl font-bold text-gray-900 dark:text-dark-text-primary">Healthcare AI Platform</span>
                <div className="text-xs text-gray-500 dark:text-dark-text-tertiary hidden lg:block">AI-powered prior-authorization for UAE insurers</div>
              </div>
            </div>
      ...
      <main>
        ...
        {/* Trust Bar */}
        <section className="py-8 bg-gray-50 dark:bg-dark-bg-secondary border-y border-gray-200 dark:border-dark-border-primary transition-colors duration-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8 text-center">
              <div className="flex items-center text-sm font-medium text-gray-600 dark:text-dark-text-secondary">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                Built for Shafafiya & eClaimLink
              </div>
              <div className="hidden md:block w-1 h-1 bg-gray-400 dark:bg-dark-text-tertiary rounded-full"></div>
              <div className="flex items-center text-sm font-medium text-gray-600 dark:text-dark-text-secondary">
        ...
        <section className="py-20 bg-white dark:bg-dark-bg-primary transition-colors duration-200" id="value">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-bold text-gray-900 dark:text-dark-text-primary mb-4">The Healthcare AI Platform Advantage</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white dark:bg-white rounded-2xl p-8 shadow-soft border border-gray-200 dark:border-gray-200 hover:shadow-medium transition-shadow text-center">
                <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <Target className="w-8 h-8 text-blue-600" />
                </div>
                <div className="text-4xl font-bold text-primary-600 mb-2">90%+</div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-900 mb-4">Automate Requests</h3>
              ...
              <div className="bg-white dark:bg-white rounded-2xl p-8 shadow-soft border border-gray-200 dark:border-gray-200 hover:shadow-medium transition-shadow text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-900 mb-4">Cut Decision Time</h3>
                <p className="text-gray-600 dark:text-gray-600 leading-relaxed">
              ...
              <div className="bg-white dark:bg-white rounded-2xl p-8 shadow-soft border border-gray-200 dark:border-gray-200 hover:shadow-medium transition-shadow text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-900 mb-4">Reduce Chronic Care Spend</h3>
                <p className="text-gray-600 dark:text-gray-600 leading-relaxed">
              ...
              <div className="bg-white dark:bg-white rounded-2xl p-8 shadow-soft border border-gray-200 dark:border-gray-200 hover:shadow-medium transition-shadow text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-900 mb-4">Get Proof, Not Promises</h3>
                <p className="text-gray-600 dark:text-gray-600 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="bg-white dark:bg-dark-bg-secondary border-t border-gray-200 dark:border-dark-border-primary py-12 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-2">
              <div className="flex items-center mb-4">
                <img src={logoImage} alt="Healthcare AI Platform" className="h-8 w-8" />
                <span className="ml-2 text-xl font-bold text-gray-900">Healthcare AI Platform</span>
              </div>
              ...
              <div className="text-sm text-gray-500">
                © 2025 Healthcare AI Platform. All rights reserved.
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="mailto:contact@healthcare-preauth.com" className="text-gray-600 hover:text-gray-900 transition-colors">Email Support</a></li>
              </ul>
            </div>
          </div>
        </div>
