        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                <span className="text-xl font-bold text-gray-900 dark:text-dark-text-primary">Nazmito</span>
        ...
        <section className="py-20 bg-white dark:bg-dark-bg-primary transition-colors duration-200" id="value">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-bold text-gray-900 dark:text-dark-text-primary mb-4">The Nazmito Advantage</h2>
            </div>
